use crate::types::{Byte, Short, Int, Long, Float, Double, Boolean, Char, Reference, ValueError, Describe};
...
impl Describe for JvmValue {
    fn descriptor(&self) -> ValueDescriptor {
        match self {
            JvmValue::Byte(value) => value.descriptor(),
            JvmValue::Short(value) => value.descriptor(),
            JvmValue::Int(value) => value.descriptor(),
            JvmValue::Long(value) => value.descriptor(),
            JvmValue::Float(value) => value.descriptor(),
            JvmValue::Double(value) => value.descriptor(),
            JvmValue::Boolean(value) => value.descriptor(),
            JvmValue::Char(value) => value.descriptor(),
            JvmValue::Reference(value) => value.descriptor(),
        }
    }
}